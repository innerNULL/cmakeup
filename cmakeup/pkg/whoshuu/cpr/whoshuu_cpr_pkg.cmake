...
macro(cmakeup_set_whoshuu_cpr_vars branch install_dir github_host)
    unset(_INSTALL_PATH)
    unset(_ORG)
    unset(_REPOSITORY)
    unset(_BRANCH)
...
endmacro(cmakeup_set_whoshuu_cpr_vars)


macro(cmakeup_build_whoshuu_cpr)
    ...
    cmakeup_cmake_build(${CMAKEUP_DEP_SRC_PATH} 
        "-DCMAKE_INSTALL_PREFIX=./install -DBUILD_SHARED_LIBS=False -DCPR_BUILD_TESTS=OFF" "install")
endmacro(cmakeup_build_whoshuu_cpr)


macro(cmakeup_set_whoshuu_cpr_lib_vars)
...
endmacro(cmakeup_set_whoshuu_cpr_lib_vars)


macro(cmakeup_integrate_whoshuu_cpr branch install_dir github_host)
    find_package(OpenSSL REQUIRED) 

    cmakeup_set_whoshuu_cpr_vars(${branch} ${install_dir} ${github_host})
    cmakeup_build_whoshuu_cpr()
    cmakeup_set_whoshuu_cpr_lib_vars()

    cmakeup_global_vars_printer()
    include_directories(${_lib_include_path})
endmacro(cmakeup_integrate_whoshuu_cpr)
