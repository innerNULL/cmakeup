...
set(VERSION "master")
set(ORGANIZATION "edenhill")
set(RESPOSITORY "librdkafka")


# https://github.com/edenhill/librdkafka/archive/refs/heads/master.zip 
...
if(EXISTS "${THIRDPARTY_ROOT}/${SRC_FOLDER_NAME}")
  ...
  execute_process(COMMAND cmake ../ -DBUILD_GMOCK=OFF -DRDKAFKA_BUILD_STATIC=ON 
