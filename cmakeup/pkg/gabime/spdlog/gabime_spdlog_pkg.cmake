...
macro(cmakeup_set_gabime_spdlog_vars branch install_dir github_host)
    unset(_INSTALL_PATH)
    unset(_ORG)
    unset(_REPOSITORY)
    unset(_BRANCH)
    ...
    set(_ORG "gabime")
    set(_REPOSITORY "spdlog")
    set(_BRANCH ${branch})
    set(_GITHUB_HOST ${github_host})
    set(_POSTFIX ${_ORG}_${_REPOSITORY}_${_BRANCH})
endmacro(cmakeup_set_gabime_spdlog_vars)


macro(cmakeup_build_gabime_spdlog)
...
endmacro(cmakeup_build_gabime_spdlog)


macro(cmakeup_set_gabime_spdlog_lib_vars)
...
endmacro(cmakeup_set_gabime_spdlog_lib_vars)


macro(cmakeup_integrate_gabime_spdlog branch install_dir github_host)
    cmakeup_set_gabime_spdlog_vars(${branch} ${install_dir} ${github_host})
    cmakeup_build_gabime_spdlog()
    cmakeup_set_gabime_spdlog_lib_vars()

    cmakeup_global_vars_printer()
    include_directories(${_lib_include_path})
endmacro(cmakeup_integrate_gabime_spdlog)
