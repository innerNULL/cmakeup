...
macro(cmakeup_set_nlohmann_json_vars branch install_dir github_host)
    unset(_INSTALL_PATH)
    unset(_ORG)
    unset(_REPOSITORY)
    unset(_BRANCH)
    ...
    set(_ORG "nlohmann")
    set(_REPOSITORY "json")
    set(_BRANCH ${branch})
    set(_GITHUB_HOST ${github_host})
    set(_POSTFIX ${_ORG}_${_REPOSITORY}_${_BRANCH})
endmacro(cmakeup_set_nlohmann_json_vars)


macro(cmakeup_build_nlohmann_json)
...
endmacro(cmakeup_build_nlohmann_json)


macro(cmakeup_set_nlohmann_json_lib_vars)
...
endmacro(cmakeup_set_nlohmann_json_lib_vars)


macro(cmakeup_integrate_nlohmann_json branch install_dir github_host)
    cmakeup_set_nlohmann_json_vars(${branch} ${install_dir} ${github_host})
    cmakeup_build_nlohmann_json()
    cmakeup_set_nlohmann_json_lib_vars()

    cmakeup_global_vars_printer()
    include_directories(${_lib_include_path})
endmacro(cmakeup_integrate_nlohmann_json)
